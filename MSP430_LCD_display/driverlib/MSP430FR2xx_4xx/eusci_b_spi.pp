    ...
    EUSCI_B_SPI_initMasterParam *param)
{
    ...
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) &= ~((0x8000) + (0x4000) + (0x1000) + (0x2000) +
        (0x0800) + (0x0600) + (0x0100));

    
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) &= ~((0x00C0));

    
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) |= (uint16_t)param->selectClockSource;

    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0006)))) =
    ...
    )
{
  ...
  (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) |= select4PinFunctionality;
}
...
void EUSCI_B_SPI_initSlave (uint16_t baseAddress, EUSCI_B_SPI_initSlaveParam *param)
{
    ...
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) |= (param->clockPhase +
                                            param->clockPolarity +
                                            param->msbFirst +
                                            (0x0100) +
                                            param->spiMode
    ...
    )
{
  ...
  (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) &= ~((0x8000) + (0x4000));
...
uint16_t EUSCI_B_SPI_isBusy (uint16_t baseAddress)
{
    ...
    return ((*((volatile uint16_t *)((uint16_t)baseAddress + (0x0008)))) & (0x0001));
}
