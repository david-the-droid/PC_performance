...
{
    (*((volatile uint8_t *)((uint16_t)0x0140 + (0x0000)))) |= (0x0020);
}

uint8_t SysCtl_getBSLEntryIndication (void)
{
    if ( (*((volatile uint8_t *)((uint16_t)0x0140 + (0x0000)))) & (0x0010)){
        return ((0x1)) ;
    } else   {
        return ((0x0)) ;
    }
...
{
    (*((volatile uint8_t *)((uint16_t)0x0140 + (0x0000)))) |= (0x0004);
}

void SysCtl_enableRAMBasedInterruptVectors (void)
{
    (*((volatile uint8_t *)((uint16_t)0x0140 + (0x0000)))) |= (0x0001);
}
...
{
    (*((volatile uint16_t *)((uint16_t)0x0140 + (0x0002)))) |= (0x8000);
}
...
{
    (*((volatile uint16_t *)((uint16_t)0x0140 + (0x0002)))) &= ~((0x4000));
}
...
{
    (*((volatile uint8_t *)((uint16_t)0x0140 + (0x0002)))) &= ~((0x0004));
    (*((volatile uint8_t *)((uint16_t)0x0140 + (0x0002)))) |= BSLRAMAssignment;
}

void SysCtl_initJTAGMailbox (uint8_t mailboxSizeSelect,
    uint8_t autoClearInboxFlagSelect)
{
    (*((volatile uint8_t *)((uint16_t)0x0140 + (0x0006)))) &= ~((0x0080) + (0x0040) + (0x0010));
    (*((volatile uint8_t *)((uint16_t)0x0140 + (0x0006)))) |=
        mailboxSizeSelect + autoClearInboxFlagSelect;
}

uint8_t SysCtl_getJTAGMailboxFlagStatus (uint8_t mailboxFlagMask)
{
    return ( (*((volatile uint8_t *)((uint16_t)0x0140 + (0x0006)))) & mailboxFlagMask);
}

void SysCtl_clearJTAGMailboxFlagStatus (uint8_t mailboxFlagMask)
{
    (*((volatile uint8_t *)((uint16_t)0x0140 + (0x0006)))) &= ~(mailboxFlagMask);
}

uint16_t SysCtl_getJTAGInboxMessage16Bit (uint8_t inboxSelect)
{
    return ( (*((volatile uint16_t *)((uint16_t)0x0140 + (0x0008) + inboxSelect))) );
}

uint32_t SysCtl_getJTAGInboxMessage32Bit (void)
{
    uint32_t JTAGInboxMessageLow = (*((volatile uint16_t *)((uint16_t)0x0140 + (0x0008))));
    uint32_t JTAGInboxMessageHigh = (*((volatile uint16_t *)((uint16_t)0x0140 + (0x000A))));
...
void SysCtl_setJTAGOutgoingMessage16Bit (uint8_t outboxSelect,
    uint16_t outgoingMessage)
{
    (*((volatile uint16_t *)((uint16_t)0x0140 + (0x000C) + outboxSelect))) = outgoingMessage;
}

void SysCtl_setJTAGOutgoingMessage32Bit (uint32_t outgoingMessage)
{
    (*((volatile uint16_t *)((uint16_t)0x0140 + (0x000C)))) = (outgoingMessage);
    (*((volatile uint16_t *)((uint16_t)0x0140 + (0x000E)))) = (outgoingMessage >> 16);
}

void SysCtl_protectFRAMWrite( uint8_t writeProtect){
    uint8_t state = (*((volatile uint8_t *)((uint16_t)0x0140 + (0x0020))));


    (*((volatile uint8_t *)((uint16_t)0x0140 + (0x0020)))) |= writeProtect;
}
...
void SysCtl_enableFRAMWrite( uint8_t writeEnable){
    ...
    (*((volatile uint8_t *)((uint16_t)0x0140 + (0x0020)))) &= ~writeEnable;
}

void SysCtl_setInfraredConfig( uint8_t dataSource,uint8_t mode, uint8_t polarity)
{
    (*((volatile uint16_t *)((uint16_t)0x0140 + (0x0022)))) &= ~((0x0008) | (0x0004) | (0x0002));

    (*((volatile uint16_t *)((uint16_t)0x0140 + (0x0022)))) |= dataSource | mode | polarity;
}

void SysCtl_enableInfrared(void)
{
    (*((volatile uint16_t *)((uint16_t)0x0140 + (0x0022)))) |= (0x0001);
}
...
{
    return (((*((volatile uint16_t *)((uint16_t)0x0140 + (0x0022)))) & 0x10) >> 4);
}

void SysCtl_setFRWPOA( uint8_t offsetAddress){
    uint16_t state = (*((volatile uint16_t *)((uint16_t)0x0140 + (0x0020))));
}
