...
void RTC_init(uint16_t baseAddress,
    ...
    uint16_t clockPredivider)
{
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) &= ~((0x3000) | (0x0700));
    
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0008)))) = modulo;
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) |= clockPredivider;
}

void RTC_start(uint16_t baseAddress, uint16_t clockSource)
{
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) &= ~(0x3000);

    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) |= clockSource;

    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) |= (0x0040);
}
    ...
    uint8_t interruptFlagMask) 
{
    ...
    if (interruptFlagMask & (0x0001)) {
        intStatus = (uint8_t)((*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) & (0x0001));
    }
