    ...
    uint16_t clockSourceDivider)
{
    ...
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) &= ~((0x0010) + (0x0002) + (0x0001));
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x001A))))  &= 0x0000; 
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x001C)))) &= 0x0000; 

    
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0002)))) = sampleHoldSignalSourceSelect 
        + (clockSourceDivider & (7*0x20u))  
        + clockSourceSelect; 

    
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0004)))) = (clockSourceDivider & (0x0300)) 
        + (0x0010); 
}
...
void ADC_setupSamplingTimer(uint16_t baseAddress,
    ...
    uint16_t multipleSamplesEnabled)
{
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0002)))) |= (0x0200);

    
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) &= ~((15*0x100u) + (0x0080));
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) |= clockCycleHoldCount + multipleSamplesEnabled;
}
    ...
    uint8_t negativeRefVoltageSourceSelect)
{
    ...
    if(!((*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) & (0x0002)))
    {
        
        if(inputSourceSelect < (10))
        {
            (*((volatile uint16_t *)((uint16_t)0x0140 + (0x0024)))) |= (1 << inputSourceSelect);
        }

        
        (*((volatile uint16_t *)((uint16_t)baseAddress + (0x000A)))) = inputSourceSelect + positiveRefVoltageSourceSelect
...
void ADC_enableInterrupt(uint16_t baseAddress,
    uint16_t interruptMask)
{
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x001A)))) |= interruptMask;
}
...
void ADC_clearInterrupt(uint16_t baseAddress,
    uint16_t interruptFlagMask)
{
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x001C)))) &= ~(interruptFlagMask);
}

uint8_t ADC_getInterruptStatus(uint16_t baseAddress,
    uint8_t interruptFlagMask)
{
    return ((*((volatile uint16_t *)((uint16_t)baseAddress + (0x001C)))) & interruptFlagMask);
}
    ...
    uint16_t conversionSequenceModeSelect)
{
    ...
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0002)))) &= ~(0x0006);
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0002)))) |= conversionSequenceModeSelect;
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) |= (0x0002) | (0x0001);
}
...
{
    if (!preempt) {
        if (!((*((volatile uint16_t *)((uint16_t)baseAddress + (0x0002)))) & (3*2u))) {
            
            
            while ((*((volatile uint16_t *)((uint16_t)baseAddress + (0x0002)))) & (0x0001));
        }
    }

    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) &= ~((0x0002));
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0002)))) &= ~((3*2u));
}

int16_t ADC_getResults(uint16_t baseAddress)
{
    return (int16_t)((*((volatile uint16_t *)((uint16_t)baseAddress + (0x0012)))));
}

void ADC_setResolution(uint16_t baseAddress,
    uint16_t resolutionSelect)
{
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0004)))) &= ~((0x0010));
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0004)))) |= resolutionSelect;
}

void ADC_setSampleHoldSignalInversion(uint16_t baseAddress,
    uint16_t invertedSignal)
{
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0002)))) &= ~((0x0100));
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0002)))) |= invertedSignal;
}

void ADC_setDataReadBackFormat(uint16_t baseAddress,
    uint16_t readBackFormat)
{
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0004)))) &= ~((0x0008));
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0004)))) |= readBackFormat;
}

void ADC_setReferenceBufferSamplingRate(uint16_t baseAddress,
    uint16_t samplingRateSelect)
{
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0004)))) &= ~((0x0004));
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0004)))) |= samplingRateSelect;
}
...
void ADC_setWindowComp(uint16_t baseAddress,
    ...
    uint16_t lowThreshold)
{
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0008)))) = highThreshold;
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0006)))) = lowThreshold;
}

uint32_t ADC_getMemoryAddressForDMA(uint16_t baseAddress)
{
    return (baseAddress + (0x0012));
}

uint8_t ADC_isBusy(uint16_t baseAddress)
{
    return ((*((volatile uint16_t *)((uint16_t)baseAddress + (0x0002)))) & (0x0001));
}
