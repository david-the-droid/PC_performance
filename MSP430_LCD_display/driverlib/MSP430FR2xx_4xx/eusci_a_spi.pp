    ...
    EUSCI_A_SPI_initMasterParam *param)
{
    ...
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0008)))) = 0;
}
...
{
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x001A)))) |= mask;
}
...
uint16_t EUSCI_A_SPI_isBusy (uint16_t baseAddress)
{
    ...
    return ((*((volatile uint16_t *)((uint16_t)baseAddress + (0x000A)))) & (0x0001));
}
