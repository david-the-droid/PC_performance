...
{
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) &= ~(3*0x10u);
    ...
    Timer_A_initContinuousModeParam *param)
{
    ...
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) &= ~((3*0x100u) +
                         (3*0x10u) +
                         (0x0004) +
                         (0x0002) +
                         (3*0x40u)
                         );
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0020)))) &= ~(7*0x0001u);
    ...
    if(param->startTimer) {
        (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) |= (2*0x10u);
    }
}
    ...
    Timer_A_initUpModeParam *param)
{
    ...
    if (param->startTimer) {
        (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) |= (1*0x10u);
    }
                             ...
                             uint16_t compareOutputMode)
{
    ...
    (*((volatile uint16_t *)((uint16_t)baseAddress + compareRegister))) = temp & ~((7*0x20u)) | compareOutputMode;
}
