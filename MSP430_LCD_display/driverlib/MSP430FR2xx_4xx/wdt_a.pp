...
void WDT_A_hold (uint16_t baseAddress)
{
    ...
    uint8_t newWDTStatus =
        (((*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) & 0x00FF) | (0x0080));

    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) = (0x5A00) + newWDTStatus;
}
...
void WDT_A_resetTimer (uint16_t baseAddress)
{
    ...
    uint8_t newWDTStatus =
        (((*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) & 0x00FF) | (0x0008));
