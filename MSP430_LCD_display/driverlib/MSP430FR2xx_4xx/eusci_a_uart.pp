...
_Bool EUSCI_A_UART_init(uint16_t baseAddress, EUSCI_A_UART_initParam *param)
{
    _Bool retVal = 0x01;
    ...
    )
{
    ...
    if (!((*((volatile uint16_t *)((uint16_t)baseAddress + (0x001A)))) & (0x0002))){
        
        while (!((*((volatile uint16_t *)((uint16_t)baseAddress + (0x001C)))) & (0x0002)));
    }
...
uint8_t EUSCI_A_UART_receiveData (uint16_t baseAddress)
{
    ...
    if (!((*((volatile uint16_t *)((uint16_t)baseAddress + (0x001A)))) & (0x0001))){
        
        while (!((*((volatile uint16_t *)((uint16_t)baseAddress + (0x001C)))) & (0x0001)));
    }
    ...
    )
{
    ...
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x001A)))) |= (uint16_t)locMask;

    locMask = (mask & ((0x0020)
        | (0x0010)));
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) |= (uint16_t)locMask;
}
...
uint8_t EUSCI_A_UART_getInterruptStatus (uint16_t baseAddress,
    uint8_t mask)
{
    return ( (*((volatile uint16_t *)((uint16_t)baseAddress + (0x001C)))) & mask );
}

void EUSCI_A_UART_clearInterrupt (uint16_t baseAddress, uint16_t mask)
{
    
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x001C)))) &= ~(mask);
}
...
uint8_t EUSCI_A_UART_queryStatusFlags (uint16_t baseAddress,
    uint8_t mask)
{
    return ( (*((volatile uint16_t *)((uint16_t)baseAddress + (0x000A)))) & mask );
}

void EUSCI_A_UART_setDormant (uint16_t baseAddress)
{
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) |= (0x0008);
}
    ...
    uint8_t transmitAddress)
{
    ...
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x000E)))) = transmitAddress;
}
...
void EUSCI_A_UART_transmitBreak (uint16_t baseAddress)
{
    ...
    if ((0x0600) ==
        ((*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) &
         (0x0600))){
        (*((volatile uint16_t *)((uint16_t)baseAddress + (0x000E)))) = 0x55;
    } else   {
        (*((volatile uint16_t *)((uint16_t)baseAddress + (0x000E)))) = 0x00;
    }
...
{
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0002)))) &= ~((0x0002) + (0x0001));

    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0002)))) |= deglitchTime;
}
