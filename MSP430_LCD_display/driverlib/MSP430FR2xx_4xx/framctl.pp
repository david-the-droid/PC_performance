    ...
    )
{
    ...
    uint8_t wp = (0x0002) | (0x0001);

    (*((volatile uint8_t *)((uint16_t)0x0140 + (0x0020)))) &= ~wp;
    ...
    (*((volatile uint8_t *)((uint16_t)0x0140 + (0x0020)))) = state;
}
...
void FRAMCtl_enableInterrupt (uint16_t interruptMask)
{
    ...
    waitSelection=((*((volatile uint8_t *)((uint16_t)0x01A0 + (0x0000)))) & 0xFF);
    
    (*((volatile uint16_t *)((uint16_t)0x01A0 + (0x0000)))) = (0xA500) | waitSelection;

    
    (*((volatile uint16_t *)((uint16_t)0x01A0 + (0x0004)))) |= interruptMask;
}

uint8_t FRAMCtl_getInterruptStatus(uint16_t interruptFlagMask)
{
	return ( (*((volatile uint16_t *)((uint16_t)0x01A0 + (0x0006)))) & interruptFlagMask );
}
...
{    
	uint8_t tempVariable = (*((volatile uint8_t *)((uint16_t)0x01A0 + (0x0000))));
	tempVariable &= ~(0x0070);
	tempVariable |= waitState;
	(*((volatile uint16_t *)((uint16_t)0x01A0 + (0x0000)))) = ( (0xA500) | tempVariable );
}
...
void FRAMCtl_delayPowerUpFromLPM(uint8_t delayStatus)
{
	...
	(*((volatile uint8_t *)((uint16_t)0x01A0 + (0x0004)))) &= ~(0x0002);
	(*((volatile uint8_t *)((uint16_t)0x01A0 + (0x0004)))) |= delayStatus;
}
