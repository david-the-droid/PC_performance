...
static void setLCDFunction(uint16_t baseAddress, uint8_t index, uint16_t value)
{
    switch (index){
    case 0:
        (*((volatile uint16_t *)((uint16_t)baseAddress + (0x000A)))) |= value;
        break;
    case 1:
        (*((volatile uint16_t *)((uint16_t)baseAddress + (0x000C)))) |= value;
        break;
    case 2:
        (*((volatile uint16_t *)((uint16_t)baseAddress + (0x000E)))) |= value;
        break;
    default:break;
    }
}
    ...
    LCD_E_initParam *initParams)
{
    ...
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) &= ~((0x0008) | (0x0010) | (0x0020) | (0x00C0)
         | (0x0002) | (0x0004) | (0xF800));
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) |= initParams->muxRate;
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) |= initParams->clockSource;
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) |= initParams->waveforms;
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) |= initParams->segments;
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) |= initParams->clockDivider;
}

void LCD_E_on(uint16_t baseAddress)
{
    (*((volatile uint16_t *)((uint16_t)0x0140 + (0x0024)))) |= (0x1000);
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) |= (0x0001);
}
...
{
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0002)))) &= ~(mask >> 8);
}

uint16_t LCD_E_getInterruptStatus(uint16_t baseAddress, uint16_t mask)
{
    return ((*((volatile uint8_t *)((uint16_t)baseAddress + (0x0002)))) & (mask >> 8));
}

void LCD_E_enableInterrupt(uint16_t baseAddress, uint16_t mask)
{
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0002)))) |= mask;
}
...
{
   (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0006)))) |= (0x0002);
}

void LCD_E_clearAllBlinkingMemory(uint16_t baseAddress)
{
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0006)))) |= (0x0004);
}

void LCD_E_selectDisplayMemory(uint16_t baseAddress, uint16_t displayMemory)
{
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0006)))) &= ~(0x0001);
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0006)))) |= displayMemory;
}

void LCD_E_setBlinkingControl (uint16_t baseAddress, uint16_t clockPrescalar,
                            uint16_t mode)
{
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0004)))) &= 
        ~((0x0010) | (0x0008) | (0x0004) | (0x0003));

    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0004)))) |= (clockPrescalar | mode);
}

void LCD_E_enableChargePump(uint16_t baseAddress)
{
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0008)))) |= (0x0080);
}
...
{
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0008)))) &= 
        ~((0x8000) | (0x4000) | (0x2000) | (0x1000));

    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0008)))) |= freq;
}

void LCD_E_setVLCDSource(uint16_t baseAddress, uint16_t r13Source,
                            uint16_t r33Source)
{
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0008)))) &= ~((0x0001) | (0x0020));

    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0008)))) |= (r13Source | r33Source);
}

void LCD_E_setVLCDVoltage(uint16_t baseAddress, uint16_t voltage)
{
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0008)))) &= ~((0x0800) | (0x0400) | (0x0200) | (0x0100));

    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0008)))) |= voltage;
}

void LCD_E_setReferenceMode(uint16_t baseAddress, uint16_t mode)
{
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0008)))) &= ~((0x0001));

    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0008)))) |= mode;
}
...
void LCD_E_setPinAsPortFunction(uint16_t baseAddress, uint8_t pin)
{
    ...
    switch (idx){
        case 0:
            (*((volatile uint16_t *)((uint16_t)baseAddress + (0x000A)))) &= ~val;
            break;
        case 1:
            (*((volatile uint16_t *)((uint16_t)baseAddress + (0x000C)))) &= ~val;
            break;
        case 2:
            (*((volatile uint16_t *)((uint16_t)baseAddress + (0x000E)))) &= ~val;
            break;
        default:break;
    }
}
...
{   
    ...
    uint8_t idx = pin>>4;
    uint16_t val = 1<<(pin & 0xF);
    uint8_t muxRate = (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) & ((0x0020) | (0x0010) | (0x0008));

    switch (idx) {
        case 0:
            (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0014)))) |= val;
            break;
        case 1:
            (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0016)))) |= val;
            break;
        case 2:
            (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0018)))) |= val;
            break;
        default:break;
    }

    
    if (muxRate <= ((0x0010) | (0x0008))) {
        if (pin & 1) {
            (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0020) + pin/2))) |= (com & 0xF) << 4;
            (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0040) + pin/2))) |= (com & 0xF) << 4;
        }
        else {
            (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0020) + pin/2))) |= (com & 0xF);
            (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0040) + pin/2))) |= (com & 0xF);
        }
    }
    else {
        
        (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0020) + pin))) |= com;
        (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0040) + pin))) |= com;
    }
}
...
{    
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0020) + memory))) = mask;
}
...
{    
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0040) + memory))) = mask;
}
