...
{
    (*((volatile uint8_t *)((uint16_t)0x0100 + (0x0000)))) |= interruptMask;
}
...
{
    return ( (*((volatile uint8_t *)((uint16_t)0x0100 + (0x0002)))) & interruptFlagMask );
}

void SFR_clearInterrupt (uint8_t interruptFlagMask)
{
    (*((volatile uint8_t *)((uint16_t)0x0100 + (0x0002)))) &= ~(interruptFlagMask);
}

void SFR_setResetPinPullResistor (uint16_t pullResistorSetup)
{
    (*((volatile uint8_t *)((uint16_t)0x0100 + (0x0004)))) &= ~((0x0008) + (0x0004));
    (*((volatile uint8_t *)((uint16_t)0x0100 + (0x0004)))) |= pullResistorSetup;
}

void SFR_setNMIEdge (uint16_t edgeDirection)
{
    (*((volatile uint8_t *)((uint16_t)0x0100 + (0x0004)))) &= ~((0x0002));
    (*((volatile uint8_t *)((uint16_t)0x0100 + (0x0004)))) |= edgeDirection;
}

void SFR_setResetNMIPinFunction (uint8_t resetPinFunction)
{
    (*((volatile uint8_t *)((uint16_t)0x0100 + (0x0004)))) &= ~((0x0001));
    (*((volatile uint8_t *)((uint16_t)0x0100 + (0x0004)))) |= resetPinFunction;
}
