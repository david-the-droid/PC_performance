...
void CRC_setSeed (uint16_t baseAddress,
    uint16_t seed)
{
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0004)))) = seed;
}

void CRC_set16BitData (uint16_t baseAddress,
    uint16_t dataIn)
{
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) = dataIn;
}

void CRC_set8BitData (uint16_t baseAddress,
    uint8_t dataIn)
{
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0000)))) = dataIn;
}

void CRC_set16BitDataReversed (uint16_t baseAddress,
    uint16_t dataIn)
{
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0002)))) = dataIn;
}

void CRC_set8BitDataReversed (uint16_t baseAddress,
    uint8_t dataIn)
{
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0002)))) = dataIn;
}

uint16_t CRC_getData (uint16_t baseAddress)
{
    return ( (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) );
}

uint16_t CRC_getResult (uint16_t baseAddress)
{
    return ( (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0004)))) );
}

uint16_t CRC_getResultBitsReversed (uint16_t baseAddress)
{
    return ( (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0006)))) );
}
